...
const DEFAULT_EVENTS = [
        ...
        subtitle: "IKSC KNOWLEDGE BRIDGE",
        description: "PUNE",
    },
    {
        year: "2025",
        title: "MASTER OF COMPUTER OF APPLICATION",
        subtitle: "INTERNATIONAL INSTITUTE OF MANAGEMENT AND SCIENCE",
        description: "PUNE",
    },
    {
        year: "2023",
        title: "BACHELOR OF COMPUTER APPLICATION",
        subtitle: "GANPATRAO ARWADE COLLEGE OF COMMERCE",
        description: "SANGLI",
    },
    {
        year: "2019",
        title: "12TH",
        subtitle: "ADARSH PUBLIC SCHOOL (CBSE)",
        description: "VITA",
    },
    {
        year: "2017",
...
export const ScrollTimeline = ({ events = DEFAULT_EVENTS, title = "SCROLL DOWN", subtitle = "", animationOrder = "sequential", cardAlignment = "alternating", lineColor = "", progressIndicator = true, cardVariant = "default", cardEffect = "none", parallaxIntensity = 0.5, progressLineWidth = 2, progressLineCap = "round", dateFormat = "badge", revealAnimation = "fade", className = "Tan bg-black text-white upperca", connectorStyle = "line", perspective = false, darkMode = false, smoothScroll = true, }) => {
